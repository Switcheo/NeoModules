...
namespace NeoModules.Core.KeyPair.Cryptography.ECC
{
	public class ECPoint : IComparable<ECPoint>, IEquatable<ECPoint>, ISerializable
	{
		...
		/// <returns>Return the result of comparison</returns>
		...
		/// <summary>
		/// Encoding objects to byte arrays
		/// </summary>
		/// <param name="commpressed">Is it a compression format encoding</param>
		/// <returns>Return encoded array of bytes</returns>
		...
		/// <summary>
		/// Compare with another object if they are equal
		/// </summary>
		/// <param name="other">Another object</param>
		/// <returns>Return the result of comparison</returns>
		...
		/// </summary>
		/// <param name="pubkey">The array of bytes to parse</param>
		/// <param name="curve">Elliptic curve parameters</param>
		/// <returns>Return the parsed public key</returns>
