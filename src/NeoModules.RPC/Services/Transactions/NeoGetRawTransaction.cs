...
namespace NeoModules.RPC.Services.Transactions
{
	...
	/// }
	/// </Summary>
	public class NeoGetRawTransaction : RpcRequestResponseHandler<DTOs.Transaction> //todo verbose dto
	{
		public NeoGetRawTransaction(IClient client) : base(client, ApiMethods.getrawtransaction.ToString())
		{
		}
		...
		public Task<DTOs.Transaction> SendRequestAsync(string txId, object id = null)
		{
			...
			return base.SendRequestAsync(id, txId, 1); //todo serialized transaction
		}
