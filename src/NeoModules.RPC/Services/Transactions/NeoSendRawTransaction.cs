...
namespace NeoModules.RPC.Services.Transactions
{
    ...
    ///     }
    /// </Summary>
    public class NeoSendRawTransaction : RpcRequestResponseHandler<bool>
    {
        public NeoSendRawTransaction(IClient client) : base(client, ApiMethods.sendrawtransaction.ToString())
        {
        }
