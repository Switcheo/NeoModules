...
namespace NeoModules.RPC.Services.Transactions
{
    ...
    /// }
    /// </summary>
    public class NeoSendAssets : RpcRequestResponseHandler<Transaction>
    {
        public NeoSendAssets(IClient client) : base(client, ApiMethods.sendtoaddress.ToString())
        {
        }

        public Task<Transaction> SendRequestAsync(string assetId, string address, int amount, object id = null)
        {
